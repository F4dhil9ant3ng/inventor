...
switch($_GET[act]){
  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
      ...
      echo "<h2>User</h2>
          <input type=button value='Tambah Admin' onclick=\"window.location.href='?module=admin&act=tambahadmin';\">";
    }
    else{
    ...
    while ($r=mysql_fetch_array($tampil)){
       echo "<tr><td>$no</td>
             ...
             <td><a href=?module=admin&act=editadmin&id=$r[id_session]>Edit</a></td></tr>";
      $no++;
    }
    echo "</table>";
    break;
