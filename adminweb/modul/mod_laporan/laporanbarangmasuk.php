 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
   ...
   echo "<h2>Laporan Barang Masuk</h2>
          ...
          <form method=POST action='?module=laporanbarangmasuk'>
          <table>
...
$sql = mysql_query("select *,DATE_FORMAT(produk.tgl_masuk, '%d-%m-%Y') as tanggal from produk,kategori,sub_kategori
					 ...
					 order BY produk.tgl_masuk DESC LIMIT $posisi,$batas");
$jml = mysql_num_rows($sql);
	echo("<form method=POST action='modul/mod_laporan/pdf_barang_masuk.php'><table><tr><th>No</th><th>Tgl Masuk</th><th>Nama Barang</th><th>Model</th><th>Kategori</th><th>S.Kategori</th><th>Vendor</th><th>Serial Number</th><th>Stok</th><th>Harga</th><th>Sub Total</th></tr>");
	...
	$jmldata = mysql_num_rows(mysql_query("select *,DATE_FORMAT(produk.tgl_masuk, '%d-%m-%Y') as tanggal from produk,kategori,sub_kategori
					 ...
					 AND produk.id_kategori=sub_kategori.id_sub_kategori 
					 AND sub_kategori.id_kategori=kategori.id_kategori
					 order BY produk.tgl_masuk DESC"));
