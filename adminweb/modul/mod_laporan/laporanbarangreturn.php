...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	include "rupiah.php";
   echo "<h2>Laporan Barang Return</h2>

          <form method=POST action='?module=laporanbarangreturn'>
          <table>
...
$sql = mysql_query("select orders.id_orders,orders.status_order,DATE_FORMAT(orders.tgl_order, '%d-%m-%Y') as tgl_order,orders.jam_order,
					...
					order BY orders_detail.tgl_return_barang DESC LIMIT $posisi,$batas");
$jml = mysql_num_rows($sql);
	echo("<form method=POST action='modul/mod_laporan/pdf_barang_return.php'><table><tr><th>No</th><th>No.Order</th><th>Id Wo</th><th>Tgl Order</th><th>Tgl Keluar</th><th>Tgl Return</th><th>Nama Barang</th><th>S.Kategori</th><th>Use For</th><th>Pelanggan</th><th>Keterangan</th><th>Jml</th><th>Harga</th></tr>");
	...
	$i = 1;
	  ...
	  echo "<tr><td colspan=12>Jumlah Total Produk : Rp.</td><td>".$jml." unit</td></tr>";
	  echo "<tr><td colspan=12>Jumlah Total Stok Barang : Rp.</td><td>".$totqu." unit</td></tr>";
	  echo(" <input type=hidden name=tglmulai value=$mulai>");
	  echo(" <input type=hidden name=tglselesai value=$selesai>");
	  echo "<tr><td colspan=13 align=right><input type=submit value=Cetak></td></tr>";
	echo("</table></form>");
