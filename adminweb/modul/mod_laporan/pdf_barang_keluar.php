...
$pdf->addText(350, 550, 16,'<b>Laporan Barang Keluar</b>');
...
$sql = mysql_query("select orders.id_orders,orders.status_order,DATE_FORMAT(orders.tgl_order, '%d-%m-%Y') as tgl_order,orders.jam_order,
					...
					orders.nama_pelanggan,produk.merk,sub_kategori.nama_sub_kategori,orders_detail.jumlah,produk.harga 
...
$pdf->ezStream();
  ...
  echo "Tidak ada transaksi/barang keluar pada Tanggal $m s/d $s";
}
}
?>
