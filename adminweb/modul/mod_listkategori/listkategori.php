...
switch($_GET[act]){
  ...
  default:
    echo "<h2>LIST PRODUK</h2>
          ...
          <table id = 'tabelku'>
          <tr><th>no</th><th>nama produk</th><th>Serial Number</th><th>berat(kg)</th><th>harga</th><th>diskon(%)</th><th>stok</th><th>tgl. masuk</th><th>aksi</th></tr>";
    ...
    echo "</table>";
	  ...
	  $totalinventory=mysql_fetch_array(mysql_query("select sum(stok) as stokbarang,
	(select count(id_produk) FROM produk ) as totalbarang FROM produk"));
